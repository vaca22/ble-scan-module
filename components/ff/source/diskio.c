...
)
{
	...
	case DEV_MMC :
        ...
        result = low_sd_read_sectors(buff, sector, count);
...
)
{
	...
	case DEV_MMC :
        ...
        result = low_sd_write_sectors(buff, sector, count);
        res = result == 0 ? RES_OK : RES_NOTRDY;
