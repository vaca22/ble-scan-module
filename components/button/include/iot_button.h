 ...
 */
typedef struct {
    button_type_t type; /**< button type, The corresponding button configuration
                           must be filled */
    union {
        button_gpio_config_t
            gpio_button_config;                /**< gpio button configuration */
 ...
 *
 * @param config pointer of button configuration, must corresponding the button
 * type
 *
 ...
 * @param btn_handle Button handle
 *
 * @return button pressed times. For example, double-click return 2,
 * triple-click return 3, etc.
 */
